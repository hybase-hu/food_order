...
class Orders(models.Model):
    ...
    approved_time = models.DateTimeField(blank=True, auto_now_add=False, null=True)
    ...
    def get_absolute_path(self):
        return "/management/orders/" + str(self.pk) + "/"


@receiver(pre_save, sender=Orders)
def orders_approved(sender, instance, **kwargs):
    if instance.approved:
        instance.approved_time = datetime.datetime.now()
